  ...
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page">Search Profiles</li>
     </ul>
   </div>
...
<div class="banner">
  <div class="container">
    <div class="banner_info">
      <a href="search_profiles.php?id=<?php echo $id; ?>&sort=<?php echo 'age';?>" class="hvr-shutter-out-horizontal">Sort by age</a> <br/>
	  <a href="search_profiles.php?id=<?php echo $id; ?>&sort=<?php echo 'height';?>" class="hvr-shutter-out-horizontal">Sort by height</a> <br/>
	  <a href="search_profiles.php?id=<?php echo $id; ?>&sort=<?php echo 'annual_income';?>" class="hvr-shutter-out-horizontal">Sort by income</a>
      <p style="font-size: 12px"> Sortings are in ascending order </p>
    </div>
  </div>
...
$sort_variable = isset($_GET['sort']) ? $_GET['sort'] : 'user_id';


$sql_users = "SELECT * FROM user_information WHERE user_id!=$profileid ORDER BY $sort_variable";
