...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2022 at 06:34 PM
...
CREATE TABLE `blocks` (
  `id` int(11) NOT NULL,
  `user_1` int(5) NOT NULL,
  `blocked_user` int(5) NOT NULL
...
INSERT INTO `blocks` (`id`, `user_1`, `blocked_user`) VALUES
(1, 27, 25),
(2, 27, 25),
(3, 27, 25),
(4, 27, 25),
...
INSERT INTO `meetings` (`id`, `user_1`, `user_2`, `meeting_date_time`) VALUES
(1, 27, 25, '2022-08-26 22:28:00'),
(2, 27, 25, '0000-00-00 00:00:00'),
(3, 27, 25, '2022-08-30 16:30:00'),
(4, 27, 15, '2022-08-27 11:30:00'),
(5, 27, 15, '2022-08-30 22:30:00');
...
INSERT INTO `reported` (`id`, `user_1`, `reported_user`) VALUES
(1, 27, 15);

-- --------------------------------------------------------

--
-- Table structure for table `send_interest`
--

CREATE TABLE `send_interest` (
  `id` int(11) NOT NULL,
  `user_1` int(11) NOT NULL,
  `interest_on_user` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `send_interest`
--

INSERT INTO `send_interest` (`id`, `user_1`, `interest_on_user`) VALUES
(1, 27, 25),
(2, 27, 25),
(3, 27, 25),
(4, 27, 25),
...
(118, 15, '', '23', 150, 'Male', 'Hindu', 'Moulvibazar', 'Sylhet', 'Bangladesh', 'Single', 'Undergraduate', 'Priom Deb', 78, 'O+', '1999-12-01', 'Student', '990000', 'Prodip Lal Deb, Retired', 'Sonchita Rani Deb, FWA', 1, 0, 'Looking for true heart.', '2022-08-15'),
...
(121, 27, '', '22', 140, 'Female', 'Hindu', 'Sylhet', 'Sylhet', 'Bangladesh', 'Single', 'HSC', 'Niladri Roy', 56, 'O+', '2000-02-10', 'Student', '100000', 'Sajal Roy, Businessman', 'Dipti Roy, Teacher', 1, 2, 'This a demo description to illustrate the functionality of this project is working as per need. We write a sample demo description while updating the profile information. If you can see this text in the description section of a user profile, that means the functionality of the mysql is working correctly.', '2022-08-24'),
(122, 28, '', '22', 148, 'Female', 'Hindu', 'Moulvibazar', 'Sylhet', 'Bangladesh', 'Single', 'HSC', 'Susmita Dash', 56, 'O+', '1998-04-12', 'Student', '210000', 'Mohesh Dash', 'Rekha Das, Retired', 1, 3, 'This a demo description to illustrate the functionality of this project is working as per need. We write a sample demo description while updating the profile information. If you can see this text in the description section of a user profile, that means the functionality of the mysql is working correctly.', '2022-08-24'),
...
--
-- Indexes for table `send_interest`
--
ALTER TABLE `send_interest`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `send_interest`
--
ALTER TABLE `send_interest`
